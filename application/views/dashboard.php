  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?php echo base_url(); ?>index.php/welcome/rute"><i class="fa fa-road"></i> <span>Rute Perjalanan</span></a></li>
        <li class="treeview">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><a href="<?php echo base_url();?>index.php/welcome/edituser/<?php echo $row['id_user']; ?>" class="btn btn-primary">Edit</a> <a onclick="return confirm('Yakin Hapus?');" href="<?php echo base_url();?>index.php/welcome/hapususer/<?php echo $row['id_user']; ?>" class="btn btn-danger">Hapus</a></td>
                </tr>
                <?php } ?>
                </tbody>
                <tfoot>
