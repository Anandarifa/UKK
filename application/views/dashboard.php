            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><a href="<?php echo base_url();?>index.php/welcome/edituser/<?php echo $row['userid']; ?>" class="btn btn-primary">Edit</a> <a onclick="return confirm('Yakin Hapus?');" href="<?php echo base_url();?>index.php/welcome/hapususer/<?php echo $row['userid']; ?>" class="btn btn-danger">Hapus</a></td>
                </tr>
                <?php } ?>
                </tbody>
                <tfoot>
