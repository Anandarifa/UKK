  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="<?php echo base_url(); ?>index.php/welcome/dashboard"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
     ...
     <section class="content">
       <div class="col-md-6">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php base_url();?>index.php/welcome/saveedituser" method="post" class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="hidden" class="form-control" value="<?php echo $userid; ?>" id="userid" name="userid" placeholder="Username">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Password</label>
                  <div class="col-sm-10">
                    <input type="password" class="form-control" value="<?php echo $password; ?>" name="password" id="inputPassword3" placeholder="Password">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Fullname</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" value="<?php echo $fullname; ?>" name="fullname" id="inputPassword3" placeholder="Fullname">
                  </div>
                </div>
              </div>
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" value="<?php echo $level; ?>" name="level" id="inputPassword3" placeholder="Level">
                  </div>
                </div>
              <!-- /.box-body -->
